...
sap.ui.define([
    ...
    return BaseController.extend("budget.controller.Object", {
        ...
        onFileChange: function(oEvent) {
            ...
            if (oEvent.getParameter("newValue") !== "") {
                ...
                this.getRouter().navTo("upload", {
                    ...
                    description: this.getView().getBindingContext().getProperty("Description") //,file: oEvent.getParameter("files")[0]					
                });
            }
        },
        /**
        ...
        onCardPress: function() {
            ...
            $.ajax({
                type: "POST",
                url: "/api/Ecritures/includeCard",
                data: {
                    CompteId: this.getView().getBindingContext().getProperty("id"),
                    Year: this.getModel("objectView").getProperty("/year"),
                    Month: this.getModel("objectView").getProperty("/month")
                },
            ...
            this.byId("detailPanel").bindElement({
                ...
                events: {
                    dataReceived: function(oEvent) {
                        ...
                        oViewModel.setProperty("/carteVisible", oData.CarteDebite === 0 && oData.Carte !== 0);
                    },
                    change: function(oEvent) {
                        var sReason = oEvent.getParameter("reason");
                        var oData = this.byId("detailPanel").getBindingContext().getObject();
                        oViewModel.setProperty("/carteVisible", oData.CarteDebite === 0 && oData.Carte !== 0 ? true : false);
                    }.bind(this)
        ...
        _initCustomFormat: function() {
            ...
            chartFormatter.registerCustomFormatter("__UI5__FloatMaxFraction2", function(value) {
            ...
            chartFormatter.registerCustomFormatter("__UI5__PercentageMaxFraction2", function(value) {
